...
class _ReviewExpressState extends State<ReviewExpress> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        index == 0
            ...
            : (index == 1 ? fullPrice =  widget.totals * 1.18 :fullPrice = widget.totals * 1.20);
  ...
  Padding TextofTitles({required String text}) {
    return Padding(
      padding: EdgeInsets.only(left: getWidth(20), right: getWidth(10), top: getHeight(30)),
      child: Text(
        text,
  ...
  Padding adress() {
    return Padding(
      padding: EdgeInsets.only(left: getWidth(20), right: getWidth(10), top: getHeight(18)),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(
